let appId = '100fe69004238baf96d465e23eb9a409';
...
function init(resultFromServer) {
    ...
    windSpeedElement.innerHTML = 'Vitesse du vent : ' + Math.floor(resultFromServer.wind.speed) + ' m/s';
    cityHeader.innerHTML = resultFromServer.name;
    humidityElement.innerHTML = 'Niveau d\'humidite a : ' + resultFromServer.main.humidity +  '%';
